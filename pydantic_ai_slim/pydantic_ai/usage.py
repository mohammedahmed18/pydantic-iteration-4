...
class UsageLimits:
    ...
    def has_token_limits(self) -> bool:
        ...
        """
        # Fast path: avoid tuple allocation if attributes are all None
        if (
            self.request_tokens_limit is None and
            self.response_tokens_limit is None and
            self.total_tokens_limit is None
        ):
            return False
        return True
