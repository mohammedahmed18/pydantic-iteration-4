...
def openai_model_profile(model_name: str) -> ModelProfile:
    ...
    key = is_reasoning_model
    try:
        return _openai_profile_cache[key]
    except KeyError:
        # Cache only two possible configurations since all other arguments are constant
        ...
        _openai_profile_cache[key] = profile
        return profile
