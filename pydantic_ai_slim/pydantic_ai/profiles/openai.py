...
def openai_model_profile(model_name: str) -> ModelProfile:
    ...
    global _reasoning_profile, _non_reasoning_profile
    is_reasoning_model = model_name.startswith('o')
    if is_reasoning_model:
        if _reasoning_profile is None:
        ...
        if _non_reasoning_profile is None:
            _non_reasoning_profile = OpenAIModelProfile(
                json_schema_transformer=OpenAIJsonSchemaTransformer,
                supports_json_schema_output=True,
                supports_json_object_output=True,
                openai_supports_sampling_settings=True,
            )
        return _non_reasoning_profile
...
_reasoning_profile = None

_non_reasoning_profile = None
